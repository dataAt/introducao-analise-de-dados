...
Escolhemos o pacote de visualização de dados **ggplot2** para **R** e **Python**, pois sua sintaxe é amigável, a qual segue o conceito de *gramática dos gráficos*. Desta forma, a comunidade Python resolveu criar uma biblioteca baseada no **ggplot2** chamada **plotnine**.
