...
```{python}
df.head() # Função que mostra o início do DataFrame carregado
...
Para iniciar a análise, da mesma forma que foi feito nos exemplos, é necessário importar o pandas
...
É isto, este foi o exemplo para mostrar que com os poucos métodos que vimos neste curso de introdução, é possível tirar várias informações do conjunto de dados, desde que, a estrutura e semântica dos dados seja entendida.
